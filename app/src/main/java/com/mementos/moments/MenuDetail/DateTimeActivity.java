...
public class DateTimeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnDatePicker, btnTimePicker, dtToDetail;
...
//        changeStatusBarColor();
        ...
        dtToDetail = findViewById(R.id.dt_to_detail);
        ...
        dtToDetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DateTimeActivity.this, BookingDetailActivity.class));
            }
        });
    }
